...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h3 class="m-t-0"><a href="{{ env('APP_URl') }}{{ app()->getLocale() }}/admin/tin-tuc-su-kien" class="btn btn-primary btn-sm"><i class="mdi mdi-reply-all"></i> {{ __('Trở về') }}</a> {{ __('Sửa Tin tức Sự kiện') }}</h3>
            <form action="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/tin-tuc-su-kien/update" method="post" id="dinhkemform" enctype="multipart/form-data">
                {{ csrf_field() }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <select name="tags" id="tags" class="form-control select2" required>
                                ...
                                @foreach($tags as $tag)
                                    <option value="{{ $tag }}" @if($t == $tag) selected @endif>{{ $tag }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                ...
                <div class="form-actions">
                    <a href="{{ env('APP_URL') }}{{ app()->getLocale() }}/admin/tin-tuc-su-kien" class="btn btn-light"><i class="fa fa-reply-all"></i> {{ __('Trở về') }}</a>
