...
@section('title', __('Sửa Nghiên cứu Khoa học'))
@section('css')
...
<div class="row">
  <div class="col-12">
        <div class="card-box">
            <h3 class="m-t-0"><a href="{{ env('APP_URL').app()->getLocale() }}/admin/nghien-cuu-khoa-hoc" class="btn btn-primary btn-sm"><i class="mdi mdi-reply-all"></i> Trở về</a> Sửa Nghiên cứu Khoa học</h3>
            <form action="{{ env('APP_URL').app()->getLocale() }}/admin/nghien-cuu-khoa-hoc/update" method="post" id="dinhkemform" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                @php
                    if(old('ma_so_nhiem_vu') != null || old('ten_nhiem_vu') != null) {
                        ...
                        $tom_tat = old('tom_tat');
                        $tu_khoa = old('tu_khoa');
                    } else if($ds['ma_so_nhiem_vu'] || $ds['ten_nhiem_vu']) {
                ...
                <div class="form-body">
                    ...
                    <div class="form-group row">
                        <label class="control-label col-md-2 text-right p-t-10">{{ _('Mã số nhiệm vụ') }}</label>
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <input type="text" id="so_dang_ky_ket_qua" name="so_dang_ky_ket_qua" class="form-control" placeholder="{{ __('Số đăng ký kết quả') }}" value="{{ $so_dang_ky_ket_qua }}"  />
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        <label class="control-label col-md-2 text-right p-t-10">{{ __('Tổ chức chủ trì') }}</label>
                        <div class="col-md-4">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-10">
                            <textarea name="tom_tat" id="tom_tat" style="height:80px;" class="form-control" placeholder="{{ __('Nội dung') }}">{{ $tom_tat }}</textarea>
                        </div>
                    </div>
                     <div class="form-group row">
